...
for epoch in range(epoch):
    for step, (x_train, y_train) in enumerate(train_db):
        ...
        # 实现梯度更新
        # w1 = w1 - lr * w1_grad tape.gradient 是自动求导结果与 [w1, b1, w2, b2] 索引为 0，1，2，3
...
plt.scatter(x1, x2, color=np.squeeze(Y_c))  # squeeze 去掉纬度是 1 的纬度,相当于去掉 [['red'], ['blue']]，内层括号变为 ['red','blue']
# 把坐标 xx, yy 和对应的值 probs 放入 contour 函数，给 probs 值为 0.5 的所有点上色，plt.show() 后显示的是红蓝点的分界线
